...
import 'package:number_trivia/core/errors/failures.dart' as _i6;
import 'package:number_trivia/core/usecase/usercase.dart' as _i8;
import 'package:number_trivia/core/util/input_convertor.dart' as _i10;
...
class MockGetConcreteNumberTrivia extends _i1.Mock
    implements _i9.GetConcreteNumberTrivia {
...
///
/// See the documentation for Mockito's code generation for more information.
class MockInputConvertor extends _i1.Mock implements _i10.InputConvertor {
  MockInputConvertor() {
    _i1.throwOnMissingStub(this);
  }

  @override
  _i3.Either<_i6.Failure, int> stringtoUnsingedInteger(String? str) =>
      (super.noSuchMethod(Invocation.method(#stringtoUnsingedInteger, [str]),
